...
function buildResearchPrompt(input) {
  return [
    ...
    "",
    "Find the official company website when missing, resolve the website domain, and identify likely public key executives from official pages or reliable public sources.",
    "For each executive, also search public web sources for a professional/business email address. Prefer emails published on official company pages, executive bios, press pages, SEC filings, or reliable public profiles. Do not invent emails, do not guess address patterns, and do not include private/personal emails unless they are clearly published by an official or reliable public source for business contact.",
